...
export async function submitRating(fieldId, rating) {
    ...
    const fingerprint =
        localStorage.getItem("vote_fingerprint") ||
        crypto.randomUUID();
    ...
    const lastUpdated =
        new Date(existingVote.last_updated);
    ...
    return {
        message: "¡Gracias por tu voto!",
        rating:
            Number(updatedRating.average_rating),
        votes:
            updatedRating.total_votes
    };
}